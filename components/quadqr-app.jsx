      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-5 flex items-center justify-between gap-4 px-1 sm:mb-7">
          <div className="flex items-center gap-3">
            <div className="relative flex size-11 items-center justify-center overflow-hidden rounded-2xl bg-slate-950 text-white shadow-sm">
              <QrCode className="size-5" />
              <span className="absolute right-1.5 top-1.5 size-1.5 rounded-full bg-red-400" />
              <span className="absolute bottom-1.5 left-1.5 size-1.5 rounded-full bg-blue-400" />
            </div>
            <div>
              <div className="flex items-center gap-2"><h1 className="text-lg font-extrabold tracking-tight text-slate-950">QuadQR</h1><span className="hidden rounded-full bg-white px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-slate-400 ring-1 ring-slate-200 sm:inline">Create & Scan</span></div>
              <p className="text-xs text-slate-500">Color QR, made simple.</p>
            </div>
          </div>
          <InstallButton />
        </header>
        ...
        <footer className="safe-bottom mt-8 pb-4 text-center text-xs leading-5 text-slate-400">
